        ...
        <?php
            if(isset($_COOKIE['customerID'])){  // Check if User is logged in
                ...
                if($balance === NULL){
                    ...
                    printf("<b>".$name."</b> current balance is <b>%.2f</b>.<br>",$balance);
                }
                ...
                if($result->num_rows > 0) {   // Check if there are records found
                    ...
                    echo "<form method='POST' action='update_transaction.php'>";
                    print("<table class='highlight' style='width: 50%;'><tr><th>ID</th><th>Code</th>
                            <th>Operation</th><th>Amount</th><th>Date Time</th><th>Note</th><th>Delete</th></tr>");
